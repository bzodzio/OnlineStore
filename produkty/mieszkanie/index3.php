...
<li class="list-group-item">
    ...
    <i class="fas fa-align-justify"></i> Wszystkie produkty</a></li>
                ...
                <li class="nav-item hidden" style="margin-top: 9px; margin-left: 8px; opacity: 1;">
                    ...
                    if ($result = $polaczenie->query("SELECT * FROM produkty WHERE kategoria='mieszkanie' ORDER BY nazwa")) {
        ...
        <div id="lista_produktow">
            ...
            $sql = "SELECT * FROM produkty WHERE kategoria='mieszkanie' ORDER BY nazwa";
