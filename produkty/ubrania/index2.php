    ...
    <div id="sklep">
        ...
        <div id="kategoria">
            <ul class="list-group">
                ...
                <li class="list-group-item active"><a href="#" style="color: white; text-decoration: none"><i class="fas fa-tshirt"></i> Ubrania</li>
...
<li class="list-group-item">
    ...
    <i class="fas fa-align-justify"></i> Wszystkie produkty</a></li>
                ...
                <li class="list-group-item"><a style="text-decoration: none; color: orange;" href="#"><i class="fas fa-tshirt"></i> Ubrania</a></li>
                ...
                <li class="nav-item hidden" style="margin-top: 9px; margin-left: 8px; opacity: 1;">
                    ...
                    if ($result = $polaczenie->query("SELECT * FROM produkty WHERE kategoria='ubrania' ORDER BY cena")) {
        ...
        <div id="lista_produktow">
            ...
            $sql = "SELECT * FROM produkty WHERE kategoria='ubrania' ORDER BY cena";
