    ...
    <div id="sklep">
        ...
        <div id="kategoria">
            <ul class="list-group">
                ...
                <li class="list-group-item active"><a href="#" style="color: white; text-decoration: none"><i class="fas fa-bicycle"></i> Sport</li>
            </ul>
        </div>
...
<li class="list-group-item">
    ...
    <i class="fas fa-align-justify"></i> Wszystkie produkty</a></li>
                ...
                <li class="list-group-item"><a style="text-decoration: none; color: orange;" href="#"><i class="fas fa-bicycle"></i> Sport</a></li>
</ul>
                            </span>
                        </div>
                    </div>
                ...
                <li class="nav-item hidden active">
                    <a class="nav-link active" href="index3.php">Alfabetycznie <i class="fas fa-caret-right"></i></a>
                </li>
                <li class="nav-item hidden" style="margin-top: 9px; margin-left: 8px; opacity: 1;">
                    ...
                    if ($result = $polaczenie->query("SELECT * FROM produkty WHERE kategoria='sport'ORDER BY nazwa")) {
        ...
        <div id="lista_produktow">
            ...
            $sql = "SELECT * FROM produkty WHERE kategoria='sport' ORDER BY nazwa";
