    ...
    <div id="sklep">
        ...
        <div id="kategoria">
            <ul class="list-group">
                ...
                <li class="list-group-item active"><a href="#" style="color: white; text-decoration: none"><i class="fas fa-car"></i> Motoryzacja</li>
...
<li class="list-group-item">
    ...
    <i class="fas fa-align-justify"></i> Wszystkie produkty</a></li>
                ...
                <li class="nav-item hidden" style="margin-top: 9px; margin-left: 8px; opacity: 1;">
                    ...
                    if ($result = $polaczenie->query("SELECT * FROM produkty WHERE kategoria='motoryzacja' ORDER BY nazwa")) {
        ...
        <div id="lista_produktow">
            ...
            $sql = "SELECT * FROM produkty WHERE kategoria='motoryzacja' ORDER BY nazwa";
