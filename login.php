...
<main id="main_start" style="background-color: white;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div id="register">
                    <div style="text-align: center; font-size: 22px; margin-bottom: 10px;">Logowanie</div>
                    <form method="post">
                        <div style="text-align: center;"><input type="text" placeholder="Wprowadź login" name="l_login"></div>

                        <div style="text-align: center;"><input type="password" placeholder="Wprowadź hasło"
                                                                name="l_haslo"></div>

                        <div style="text-align: center;"><input type="submit" value="Zaloguj"></div>
...
<footer>
    <div id="footer" style="position:fixed; bottom: 0; z-index: -5;">
